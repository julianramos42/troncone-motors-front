          ...
          <div className="container mx-auto px-4">
            <div className="text-center">
              ...
              <p className="text-md md:text-xl text-[#E3E3E3] max-w-2xl mx-auto">
                Explora nuestra amplia selección de vehículos usados y nuevos
                con garantía y financiamiento disponible
              </p>
            </div>
          </div>
        </section>
                      ...
                      <CardContent className="p-4">
                        <div className="space-y-3">
                          ...
                          <div className="flex gap-2 pt-2">
                            ...
                            <Link
                              href={`https://api.whatsapp.com/send?phone=+5491137437882&text=Hola, vi en la web el ${car.nombre} ${car.color}, año ${car.anio} y me gustaría obtener más información`}
                              target="_blank"
                            >
                              <Button
                                size="sm"
